...
<form method="get" action="gongji_write.jsp"> 
	...
	제목: <input type=text name=get_title size=70 maxlength=70 onkeyup='characterCheck(this); noSpaceForm(this);' onkeydown='characterCheck(this); noSpaceForm(this);' onchange='noSpaceForm(this);' autocomplete='off' onpaste='return false;' required>
	일자: <input type=text name=get_date readonly>
